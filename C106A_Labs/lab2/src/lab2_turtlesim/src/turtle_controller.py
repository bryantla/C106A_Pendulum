...
def talker():
    ...
    while not rospy.is_shutdown():
        ...
        vel = Twist()
        user_input = input('Please enter linear velocity x and press <Enter>:')
        vel.linear.x = float(user_input)
        user_input = input('Please enter linear velocity y and press <Enter>:')
        vel.linear.y = float(user_input)
        user_input = input('Please enter linear velocity z and press <Enter>:')
        vel.linear.z = float(user_input)
        user_input = input('Please enter angular velocity x and press <Enter>:')
        vel.angular.x = float(user_input)
        user_input = input('Please enter angular velocity y and press <Enter>:')
        vel.angular.y = float(user_input)
        user_input = input('Please enter angular velocity z and press <Enter>:')
        vel.angular.z = float(user_input)
